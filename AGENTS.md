...
Этот репозиторий — Telegram-бот "Нейро Анатолий". Бот консультирует пользователей по вопросам здоровья, рекомендует и консультирует по товарам каталога "Сибирского Здоровья". Бот работает на **Cloudflare Workers** и библиотеке **grammy**. Бот:
